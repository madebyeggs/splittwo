class ReleasesController < ApplicationController
  before_action :authenticate_user!, :except => ["index", "show"]
    ...
    def release_params
      params.require(:release).permit(:release_id, :title, :soundcloud, :description, :image, :fb_image, :row_order_position, :slideshow, :slide_image, :slide_title ,:slide_title2, :slide_title3, :Slideshowposition)
    end
