class WorksController < ApplicationController
  before_action :authenticate_user!, :except => ["index", "show"]
    ...
    def work_params
      ...
      :fb_image, :slideshow, :slide_image, :slide_title, :slide_title2, :slide_title3, :row_order_position, :vimeo, :Slideshowposition, :platform, :newsletter, :newsletterposition, :hero)
    end
