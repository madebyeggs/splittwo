...
//	});
	...
	if($(window).width() > 992){
    	$('.artist').hover(function(){
        	$(this).find('.info-wrapper').stop().fadeIn('50');
        },
        function(){
        	$(this).find('.info-wrapper').stop().fadeOut('50');
        });
    } else {
		$('.info-wrapper').show();
	}
	...
	var options = {clickToPlay: true, controls: ['play', 'progress', 'current-time', 'mute', 'volume', 'fullscreen']}
